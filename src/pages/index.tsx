  ...
  return (
    <Layout>
      ...
      <main>
          ...
          {({ ref, inView }) => (
            ...
            >
              <div className='absolute inset-0 -z-10 -translate-y-32'>
                <svg
                  className='absolute top-0 left-[max(50%,25rem)] h-[64rem] w-[128rem] -translate-x-1/2 stroke-gray-200 [mask-image:radial-gradient(48rem_48rem_at_center,white,transparent)]'
                  aria-hidden='true'
                >
                  <defs>
                    <pattern
              ...
              <div className='container mx-auto overflow-hidden pb-4'>
                <div className='flex flex-wrap items-center'>
                  ...
                  <div className='ml-auto mr-auto mt-24 w-full px-12 md:w-4/12 md:px-4'>
                    ...
                    <p
                      ...
                      data-fade='8'
                    >
                      In order to gain more experience in developing, I always
                      look for opportunity to join a project or to work on a
                      project together.
                    </p>
                    <p
                      className='mt-4 mb-4 text-lg font-light leading-relaxed text-slate-600'
                      data-fade='8'
                    >
                      I&apos;m always looking for new ideas to gain new
        ...
        <InView triggerOnce>
          <section className='container mx-auto mb-48 overflow-hidden pb-20'>
            <div className='flex flex-wrap items-center'>
              <div className='ml-auto mr-auto mt-48 w-full px-12 md:w-4/12 md:px-4'>
                ...
                <p className='mt-4 mb-4 text-lg font-light leading-relaxed text-slate-600'>
                  I will include my result of library crafting components in
                  this section too.
                </p>
