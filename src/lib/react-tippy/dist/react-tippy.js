...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['reactTippy'] = factory(
      require('react'),
      require('popper.js'),
      require('react-dom')
    );
  else
    root['reactTippy'] = factory(
      root['React'],
      root['Popper'],
      root['ReactDOM']
    );
    ...
    return /******/ (function (modules) {
      ...
      /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
           ...
           */
          var DefaultsKeys = (exports.DefaultsKeys =
            Browser.SUPPORTED && Object.keys(Defaults));
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function prefix(property) {
            ...
            for (var i = 0; i < prefixes.length; i++) {
              ...
              if (
                typeof window.document.body.style[prefixedProp] !== 'undefined'
              ) {
                return prefixedProp;
              }
            }
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var detectPropsChanged = function detectPropsChanged(
            props,
            prevProps
          ) {
            var result = [];
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function followCursorHandler(e) {
            ...
            var position = (0, _getCorePlacement2.default)(
              popper.getAttribute('x-placement')
            );
            ...
            var isRightOverflowing =
              pageX + viewportPadding + halfPopperWidth + offset > pageWidth;
            var isLeftOverflowing =
              pageX - viewportPadding - halfPopperWidth + offset < 0;
            ...
            popper.style[(0, _prefix2.default)('transform')] =
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function bindEventListeners() {
            var touchHandler = function touchHandler() {
              ...
              if (
                _globals.Browser.dynamicInputDetection &&
                window.performance
              ) {
            ...
            var clickHandler = function clickHandler(event) {
              ...
              var el = (0, _closest2.default)(
                event.target,
                _globals.Selectors.TOOLTIPPED_EL
              );
              var popper = (0, _closest2.default)(
                event.target,
                _globals.Selectors.POPPER
              );
              ...
              if (el) {
                ...
                if (
                  (!multiple && _globals.Browser.touch) ||
                  (!multiple && trigger.indexOf('click') !== -1)
                ) {
            ...
            var blurHandler = function blurHandler(event) {
              ...
              if (
                el &&
                el.blur &&
                _matches.matches.call(el, _globals.Selectors.TOOLTIPPED_EL)
              ) {
                el.blur();
              }
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _getOffsetDistanceInPx2 = _interopRequireDefault(
            _getOffsetDistanceInPx
          );
          ...
          function createPopperElement(id, title, settings) {
            ...
            tooltip.setAttribute(
              'class',
              'tippy-tooltip tippy-tooltip--' + size + ' leave'
            );
            ...
            tooltip.style[(0, _getCorePlacement2.default)(position)] = (0,
            ...
            var config = _extends(
              ...
              popperOptions || {},
              {
                ...
                onUpdate: function onUpdate() {
                  ...
                  styles.right = '';
                  styles[
                    (0, _getCorePlacement2.default)(
                      popper.getAttribute('x-placement')
                    )
                  ] = (0, _getOffsetDistanceInPx2.default)(distance);
                },
              }
            );
            ...
            if (window.MutationObserver) {
              ...
              var observer = new MutationObserver(function () {
                ...
                (0, _defer2.default)(function () {
                  styles[(0, _prefix2.default)('transitionDuration')] =
                    flipDuration + 'ms';
                });
              });
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _getIndividualSettings2 = _interopRequireDefault(
            _getIndividualSettings
          );

          var _createPopperElement = __webpack_require__(17);

          var _createPopperElement2 =
            _interopRequireDefault(_createPopperElement);
          ...
          var _getEventListenerHandlers2 = _interopRequireDefault(
          ...
          function createTooltips(els) {
            ...
            return els.reduce(function (a, el) {
              ...
              var popper = (0, _createPopperElement2.default)(
                id,
                title,
                settings
              );
              var handlers = _getEventListenerHandlers2.default.call(
                _this,
                el,
                popper,
                settings
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _cursorIsOutsideInteractiveBorder2 = _interopRequireDefault(
            _cursorIsOutsideInteractiveBorder
          );
          ...
          function getEventListenerHandlers(el, popper, settings) {
            ...
            var show = function show(event) {
              return _this.callbacks.wait
                ? _this.callbacks.wait.call(popper, _show, event)
                : _show();
            };
            ...
            var handleTrigger = function handleTrigger(event) {
              ...
              isClick && (0, _isVisible2.default)(popper) && isNotPersistent
                ? hide()
                : show(event);
            ...
            var handleMouseleave = function handleMouseleave(event) {
              ...
              if (interactive) {
                ...
                var handleMousemove = function handleMousemove(event) {
                  ...
                  var closestTooltippedEl = (0, _closest2.default)(
                    event.target,
                    _globals.Selectors.TOOLTIPPED_EL
                  );
                  ...
                  var isOverOtherTooltippedEl =
                    closestTooltippedEl && closestTooltippedEl !== el;
                  ...
                  if (
                    (0, _cursorIsOutsideInteractiveBorder2.default)(
                      event,
                      popper,
                      settings
                    )
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function hideAllPoppers(exclude) {
            _globals.Store.forEach(function (refData) {
              ...
              var isHideOnClick =
                hideOnClick === true || trigger.indexOf('focus') !== -1;
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _bindEventListeners2 =
            _interopRequireDefault(_bindEventListeners);
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function makeSticky(refData) {
            ...
            var applyTransitionDuration = function applyTransitionDuration() {
              return (popper.style[
                (0, _prefix2.default)('transitionDuration')
              ] = stickyDuration + 'ms');
            };
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _followCursorHandler2 =
            _interopRequireDefault(_followCursorHandler);

          var _createPopperInstance = __webpack_require__(18);

          var _createPopperInstance2 = _interopRequireDefault(
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function onTransitionEnd(data, duration, callback) {
            ...
            var _getInnerElements = (0, _getInnerElements3.default)(
                data.popper
              ),
              tooltip = _getInnerElements.tooltip;
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          var _elementIsInViewport2 =
            _interopRequireDefault(_elementIsInViewport);
          ...
          var _applyTransitionDuration2 = _interopRequireDefault(
          ...
          var _getArrayOfElements2 =
            _interopRequireDefault(_getArrayOfElements);
          ...
          var Tippy = (function () {
            function Tippy(selector) {
              ...
              this.store = _createTooltips2.default.call(
                this,
                (0, _getArrayOfElements2.default)(selector)
              );
            ...
            _createClass(Tippy, [
              ...
              },
              {
                ...
                value: function updateForReact(popper, updatedContent) {
                  var tooltipContent = popper.querySelector(
                    _globals.Selectors.CONTENT
                  );
                  var data = (0, _find2.default)(this.store, function (data) {
                    return data.popper === popper;
                  });
              ...
              },
              {
                ...
                value: function show(popper, customDuration) {
                  ...
                  var _getInnerElements = (0, _getInnerElements5.default)(
                      popper
                    ),
                    tooltip = _getInnerElements.tooltip,
                  ...
                  (0, _applyTransitionDuration2.default)(
                    [popper, tooltip, circle],
                    0
                  );
                  ...
                  (0, _defer2.default)(function () {
                    ...
                    (0,
                    _applyTransitionDuration2.default)([tooltip, circle], _duration);
                    ...
                    (0,
                    _modifyClassList2.default)([tooltip, circle], function (list) {
                      list.contains('tippy-notransition') &&
                    ...
                    (0,
                    _onTransitionEnd2.default)(data, _duration, function () {
                      if (
                        !(0, _isVisible2.default)(popper) ||
                        data._onShownFired
                      )
              ...
              },
              {
                ...
                value: function hide(popper, customDuration) {
                  ...
                  var _getInnerElements2 = (0, _getInnerElements5.default)(
                      popper
                    ),
                  ...
                  var isUnmount =
                    data &&
                    data.settings &&
                    data.settings.unmountHTMLWhenHide &&
                  ...
                  (0, _applyTransitionDuration2.default)(
                    [tooltip, circle, circle ? content : null],
                    _duration
                  );

                  if (circle) content.style.opacity = 0;

                  (0, _modifyClassList2.default)(
                    [tooltip, circle],
                    function (list) {
                      list.contains('tippy-tooltip') &&
                        list.remove('tippy-notransition');
                      list.remove('enter');
                      list.add('leave');
                    }
                  ...
                  if (
                    ...
                    (0, _elementIsInViewport2.default)(el)
                  ) {
                    el.focus();
                  }
              ...
              },
              {
                ...
                value: function update(popper) {
                  ...
                  var _getInnerElements3 = (0, _getInnerElements5.default)(
                      popper
                    ),
              ...
              },
              {
                ...
                value: function destroy(popper, _isLast) {
                  ...
                  _globals.Store.splice(
                    (0, _findIndex2.default)(_globals.Store, function (data) {
                      return data.popper === popper;
                    }),
                    1
                  );
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function applyTransitionDuration(els, duration) {
            els.forEach(function (el) {
              ...
              var isContent = _matches.matches.call(
                el,
                _globals.Selectors.CONTENT
              );
              ...
              el.style[(0, _prefix2.default)('transitionDuration')] =
                _duration + 'ms';
            });
          }
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function cursorIsOutsideInteractiveBorder(event, popper, settings) {
            ...
            var corePosition = (0, _getCorePlacement2.default)(
              popper.getAttribute('x-placement')
            );
            ...
            return (
              exceeds.top || exceeds.bottom || exceeds.left || exceeds.right
            );
          }
