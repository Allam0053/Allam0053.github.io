...
export const createSlugView = async (slug) => {
...
export const getViewBySlug = async (slug) => {
...
export const updateView = async (ref, data) => {
...
export const createContent = async (slug) => {
  return await faunaClient.query(
...
export const getContentMeta = async (slug) => {
  return await faunaClient.query(
    q.Let(
      {
...
export const upsertContentMeta = async (slug) => {
  return await faunaClient.query(
    q.Let(
      {
...
export const upsertLikeByUser = async (slug, sessionId) => {
  return await faunaClient.query(
    q.Let(
      {
        match: q.Match(q.Index('get_contents_by_slug'), slug),
