          ...
          <div className='w-full text-center lg:w-8/12'>
            ...
            <div className='mt-10 flex flex-col sm:block'>
              <a
                ...
                className='get-started mr-1 mb-2 rounded bg-slate-400 px-6 py-4 text-sm font-bold uppercase text-white shadow outline-none transition-all duration-150 ease-linear hover:shadow-lg focus:outline-none active:bg-slate-500'
              >
                Get started
              </a>
              <a
                href='https://github.com/creativetimofficial/notus-nextjs?ref=nnjs-index'
                className='github-star mr-1 mb-1 rounded bg-slate-700 px-6 py-4 text-sm font-bold uppercase text-white shadow outline-none hover:shadow-lg focus:outline-none active:bg-slate-600 sm:ml-1'
              >
