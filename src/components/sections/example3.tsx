        ...
        <div className='flex flex-wrap justify-center'>
          <div className='ml-auto mr-auto w-full px-12 md:mt-64 md:w-5/12 md:px-4'>
            ...
            <a
              ...
              className='github-star mt-4 mr-1 mb-1 inline-block rounded bg-slate-700 px-6 py-4 text-sm font-bold uppercase text-white shadow outline-none hover:shadow-lg focus:outline-none active:bg-slate-600'
            >
              Github Star
            </a>
          </div>
          ...
          <div className='relative mr-auto ml-auto mt-32 w-full px-4 md:w-4/12'>
            <i className='fab fa-github absolute -top-150-px -right-100 left-auto text-55 text-slate-700 opacity-80'></i>
          </div>
        </div>
      </div>
    </section>
