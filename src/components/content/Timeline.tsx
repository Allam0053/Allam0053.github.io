...
/**
 * theme
 * ol : border-gray-200 dark:border-gray-700
 */
      ...
      {content.map((item, index) => {
        return (
          <li className='mb-10 ml-6' key={`tl-${index}`}>
            ...
            <h3
              className={clsxm(
                'mb-1 flex items-center text-lg font-semibold',
            ...
            <time
              className={clsxm(
                'mb-2 block text-sm font-normal leading-none',
                theme === 'light' ? 'text-gray-400' : 'dark:text-gray-500'
              )}
            >
              {item.date}
            </time>
